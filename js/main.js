...
const GRAFICA_PROJECTS = {
  vitaelis: {
    ...
    images: [
      'assets/projects/grafica/1-vitaelis/1.jpg',
      'assets/projects/grafica/1-vitaelis/2.jpg',
      'assets/projects/grafica/1-vitaelis/3.jpg',
      'assets/projects/grafica/1-vitaelis/4.jpg',
      'assets/projects/grafica/1-vitaelis/5.jpg',
      'assets/projects/grafica/1-vitaelis/6.jpg',
      'assets/projects/grafica/1-vitaelis/7.jpg',
      'assets/projects/grafica/1-vitaelis/8.jpg',
      'assets/projects/grafica/1-vitaelis/9.jpg',
      'assets/projects/grafica/1-vitaelis/10.jpg',
      'assets/projects/grafica/1-vitaelis/11.jpg',
      'assets/projects/grafica/1-vitaelis/12.jpg',
      'assets/projects/grafica/1-vitaelis/13.jpg',
      'assets/projects/grafica/1-vitaelis/14.jpg',
      'assets/projects/grafica/1-vitaelis/15.jpg',
      'assets/projects/grafica/1-vitaelis/16.jpg',
      'assets/projects/grafica/1-vitaelis/17.jpg',
      'assets/projects/grafica/1-vitaelis/18.jpg',
    ]
  },
  review: {
    title: 'Review',
    ...
    images: Array.from({length:15}, (_,i) => `assets/projects/grafica/2-review/${i+1}.jpg`)
  },
  avis: {
    title: 'Avis',
    tags: 'Campagna Sociale',
    desc: 'Rebranding completo per associazione no-profit.',
    images: Array.from({length:13}, (_,i) => `assets/projects/grafica/3-avis/${i+1}.jpg`)
  },
  manavi: {
    title: 'Manavi',
    tags: 'Brand Identity · Fashion',
    desc: 'Identità e packaging per brand fashion.',
    images: Array.from({length:17}, (_,i) => `assets/projects/grafica/4-manavi/${i+1}.jpg`)
  },
  zipeatz: {
    title: 'ZipEatz',
    tags: 'Brand Identity · Packaging',
    ...
    images: [
      'assets/projects/grafica/5-zipeatz/1.jpg',
      'assets/projects/grafica/5-zipeatz/2.jpg',
      'assets/projects/grafica/5-zipeatz/3.jpg',
      'assets/projects/grafica/5-zipeatz/4.jpg',
      'assets/projects/grafica/5-zipeatz/5.jpg',
      'assets/projects/grafica/5-zipeatz/6.jpg',
      'assets/projects/grafica/5-zipeatz/7.jpg',
      'assets/projects/grafica/5-zipeatz/8.jpg',
      'assets/projects/grafica/5-zipeatz/9.jpg',
    ]
  },
  orsosobrio: {
    title: 'Orso Sobrio',
    ...
    images: Array.from({length:7}, (_,i) => `assets/projects/grafica/6-orsosobrio/${i+1}.jpg`)
  },
  anymalia: {
    title: 'Anymalia',
    tags: 'Brand Identity · Logo',
    desc: 'Identità visiva per brand nel settore animali.',
    images: Array.from({length:12}, (_,i) => `assets/projects/grafica/7-anymalia/${i+1}.jpg`)
  },
  diriso: {
    title: 'Di Riso',
    ...
    images: [
      ...Array.from({length:4}, (_,i) => `assets/projects/grafica/8-diriso/${i+1}.jpg`),
      ...Array.from({length:6}, (_,i) => `assets/projects/grafica/8-diriso/${i+6}.jpg`)
    ]
  }
};
